...
// Create some buttons
final JoystickButton intakeBtnFast = new JoystickButton(rightJoystick, 3);        
intakeBtnFast.whileHeld(new RunIntake(0, m_intake) ,true);
    SmartDashboard.putData("intakeBtnFast",new RunIntake(0, m_intake) );

final JoystickButton intakeBtnSlow = new JoystickButton(rightJoystick, 2);        
intakeBtnSlow.whileHeld(new RunIntake(0.4, m_intake) ,true);
    SmartDashboard.putData("intakeBtnSlow",new RunIntake(0.4, m_intake) );

final JoystickButton intakeBtn = new JoystickButton(rightJoystick, 1);        
intakeBtn.whileHeld(new RunIntake(0.8, m_intake) ,true);
    SmartDashboard.putData("intakeBtn",new RunIntake(0.8, m_intake) );
