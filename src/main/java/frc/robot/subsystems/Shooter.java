...
private WPI_TalonFX shooterMotor;
    ...
    private static final double SPEED_P_CONSTANT = .5;
    private static final double SPEED_I_CONSTANT = .05;
    private static final double SPEED_D_CONSTANT = .1;
    private static final double SPEED_F_CONSTANT = 1;    
    /**
    *
    */
    public Shooter() {
