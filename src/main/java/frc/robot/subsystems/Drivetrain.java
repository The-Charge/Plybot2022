...
public class Drivetrain extends SubsystemBase {
    ...
    private static final double TICKS_PER_METER = 10000;
    private static final double THRESHOLD = 500;
    private static final int TIMEOUT_MS = 10;    

    private static final double MM_P = 0;
    private static final double MM_I = 0;
    private static final double MM_D = 0;
    private static final double MM_F = 0;
...
private AnalogGyro doNotUse;
    ...
    private final SpeedControllerGroup m_leftMotors = new SpeedControllerGroup(leftFrontMotor, leftBackMotor);

  private final SpeedControllerGroup m_rightMotors = new SpeedControllerGroup(rightFrontMotor, rightBackMotor);
...
doNotUse = new AnalogGyro(0);
 ...
 doNotUse.setSensitivity(0.007);
    ...
    public void initMotionMagic(double velocity, double acceleration, double distance){
        MM_distance = distance * TICKS_PER_METER;
    ...
    public boolean isAtPIDDestination(){
        return (Math.abs(leftFrontMotor.getSelectedSensorPosition() - MM_distance) < THRESHOLD)
            || (Math.abs(rightFrontMotor.getSelectedSensorPosition() - MM_distance) < THRESHOLD);
    }
